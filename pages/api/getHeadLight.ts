...
const testGit = {
  ...
  starred_url: "https://api.github.com/users/hirishu10/starred{/owner}{/repo}",
  ...
  received_events_url: "https://api.github.com/users/hirishu10/received_events",
  type: "User",
  site_admin: false,
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "GET") {
    try {
      ...
      let x = [];
      firestore.onSnapshot(mainDocument, {
        next: (d) => {
