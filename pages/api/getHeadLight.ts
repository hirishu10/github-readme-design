...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  axios
    ...
    .then((response) => {
      console.log(
        "response?.data() :>> ",
        response?.data?.message?.toTimeStamp
      );
      ...
      const testGit = {
        ...
        subscriptions_url:
          "https://api.github.com/users/hirishu10/subscriptions",
      ...
      fs.writeFile("headLight.svg", rawData(`${getCustomFullDateAndTimeWithAmPmIncludingSeconds()}`), (err) => {
