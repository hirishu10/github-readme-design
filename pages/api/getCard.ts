...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const head =
    ...
    `
    <svg width="1280" height="200" viewBox="0 0 1280 200" xmlns="http://www.w3.org/2000/svg" style="font-family: Poppins; border: 1px solid silver;">
    <style>
    ...
    <g>
    <text x="1150" y="190" text-anchor="start" font-size="10" fill="#e3e3e3" font-family="Poppins">Github-Readme-Design</text>
    </g>
    </svg>
`;
