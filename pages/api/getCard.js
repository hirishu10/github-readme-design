...
export default function handler(req, res) {
  ...
  if (req.method === "GET") {
    ...
    try {
      ...
      // *
      res.send(
        '<svg width="800" height="200" xmlns="http://www.w3.org/2000/svg" color="red"><g className={sCode.groupFirst}> <rect width="100%" height="40%" fill="lightgreen" strokewidth="1" /><text className={sCode.textLayout} x="10" y="50" textAnchor="start" font-size="30" >\'{name}\'</text><text className={sCode.textLayout} x="500" y="50" textAnchor="start" fontSize="18">{getDateTime}</text></g></svg>'
      );
